...
%\cvitem{Machine Learning}{regression, classification, clustering; xgboost, lightgbm, etc} 
...
Creating roadmap and portfolio for data science projects on operation area. 

Leading data science projects in the tech areas of math optimization, forecasting, and function areas in operations, customer service, call center, and marketing.
