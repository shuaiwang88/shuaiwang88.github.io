...
\cvitem{Time Series}{anomaly detection; forecasting: ARIMA, Prophet}
...
My own consulting practice. So far, the clients include: 
\begin{itemize}
...
\item Pratik Parikh: Chair of Dept of Industrial Engineering, University of Louisville.t
\item Nan Kong: Purdue University. 
\item Caroline Cao: University of South Australia/IMT Atlantique.
\item Subhashini Ganapathy: Chair Dept of Biomedical, Industrial \& Human Factors Engineering, Wright State University.
\end{enumerate}
 \end{itemize}
