...
\cvitem{Optimization}{\textsc{AIMMS},  \textsc{Pyomo}, \testsc{Minizinc}, \textsc{JuMP}, \textsc{CPLEX}, \textsc{GUROBI}, \textsc{CBC}}
...
Kroger}{\textsc{Kroger}}{Cincinnati,OH}{}
{} %
{
...
\bigskip
\cventry{2017.9--Present}{Lead Data Science Consultant at Kroger/84.51}
...
\item \textbf{Teaching}: Since Oct 2020,
    I teach at an Artificial Intelligence and Machine Learning certificate program at University of Texas, Austin collaborated with GreatLearning.com
}
