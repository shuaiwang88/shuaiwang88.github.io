...
\homepage{github.com/shuaiwang88}
...
\cvitem{Data Mining}{\textsc{Datarobot}, \textsc{H2O}, \textsc{scikit-learn}, \textsc{tree-based boosting}} 
...
\cventry{2012.3--Present}{Lead Operations Research / Data Science Consultant 
}{\textsc{Kroger.Co}}{Cincinnati,OH}{}{Role: make mathematical model, implement 
core algorithm}{
% \newline{}
...
jointly developed with \textsc{A.T.Kearney} to optimize promotion planning and
assortment selection to benefit the overall revenue gain. System is
...
%\newline{}
\item \textbf{Pharmacy Inventory Transfer}: The problem is to ship medical
drugs from stores with excess to stores with needs so as to: 1) reduce
...
reduced. The model is piloted in 121 Columbus pharmacy stores and is expected
to produce \$30 to \$50 million savings in obsolesce as well as reduction in
out-of-stock (OOS).
%\newline{}
...
\item \textbf{Picking Staff Daily Scheduling System Optimization}: System built to optimize the scheduling of the picking staff at store daily. It saves more than 20\%  to 30 \% labor 
